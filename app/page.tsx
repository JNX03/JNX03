...
const FloatingElement = ({
  ...
  delay = 0,
  followScroll = false,
}: { children: React.ReactNode; delay?: number; followScroll?: boolean }) => {
  ...
  return (
    <motion.div
      initial={{ y: 0 }}
      animate={{
        y: followScroll ? [scrollY, scrollY - 10, scrollY] : [0, -10, 0],
      }}
      transition={{
      ...
      style={followScroll ? { position: "relative", top: scrollY } : {}}
    >
      {children}
    </motion.div>
  )
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-12 items-center lg:grid-cols-2">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                ...
                >
                  {["Machine Learning", "Computer Vision", "NLP", "Full Stack", "Cybersecurity"].map((tag, i) => (
                    <motion.span
                      key={tag}
              ...
              >
                <FloatingElement followScroll={true}>
        ...
        <section className="py-16">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <ProjectCard
              title="Nova Security"
              description="AI-powered automated penetration testing and bug bounty platform for businesses."
              image="/img/nova-security.png"
              delay={0.2}
            />
            <ProjectCard
              title="NoteX"
              description="A comprehensive note-taking platform for high school subjects with progress tracking."
              image="/img/notex.png"
              delay={0.3}
            />
          </div>
        ...
        <section className="py-16">
          <div className="grid gap-8 md:grid-cols-2 items-center">
            ...
            >
              <h2 className="text-3xl font-bold mb-4">Meet Yuki-Chan</h2>
              <p className={`text-lg ${theme === "light" ? "text-gray-600" : "text-muted-foreground"} mb-6`}>
                My latest AI assistant project, designed to help with programming, learning, and everyday tasks.
                Yuki-Chan combines natural language processing with a friendly interface.
              </p>
            ...
            >
              <MagneticElement className="h-full" strength={0.05}>
                <Card className={`h-full overflow-hidden border-0 shadow-lg ${theme === "light" ? "bg-white" : ""}`}>
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold mb-2">AI Innovator Award 2024</h3>
                    <p className={`${theme === "light" ? "text-gray-600" : "text-muted-foreground"}`}>
                      Winner of the Young Innovator category with a prize of 100,000 THB.
                    </p>
                  </CardContent>
                </Card>
              </MagneticElement>
            ...
            >
              <MagneticElement className="h-full" strength={0.05}>
                <Card className={`h-full overflow-hidden border-0 shadow-lg ${theme === "light" ? "bg-white" : ""}`}>
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold mb-2">Thailand ICT Awards 2023</h3>
                    <p className={`${theme === "light" ? "text-gray-600" : "text-muted-foreground"}`}>
                      Winner Award in the Senior Category for innovative technology solutions.
                    </p>
                  </CardContent>
                </Card>
              </MagneticElement>
            ...
            >
              <MagneticElement className="h-full" strength={0.05}>
                <Card className={`h-full overflow-hidden border-0 shadow-lg ${theme === "light" ? "bg-white" : ""}`}>
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold mb-2">APICTA 2023</h3>
                    <p className={`${theme === "light" ? "text-gray-600" : "text-muted-foreground"}`}>
                      Merit Award at the Asia Pacific ICT Alliance Awards in Hong Kong.
                    </p>
                  </CardContent>
                </Card>
              </MagneticElement>
